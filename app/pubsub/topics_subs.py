...
TOPICS: Dict[str, str] = {
    ...
    "PRACTICE_PRONUNCIATION_REQUEST": "practice-pronunciation-request-topic",
    "PRACTICE_PRONUNCIATION_DONE": "practice-pronunciation-done-topic",
...
SUBSCRIPTIONS: Dict[str, str] = {
    ...
    "PRACTICE_PRONUNCIATION_REQUEST": "practice-pronunciation-request-topic-sub",
    "PRACTICE_PRONUNCIATION_DONE": "practice-pronunciation-done-topic-sub",
